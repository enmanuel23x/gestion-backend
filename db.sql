...
-- -----------------------------------------------------
-- Table `db_gestion_ocupacion`.`table1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db_gestion_ocupacion`.`table1` ;
...
CREATE TABLE IF NOT EXISTS `db_gestion_ocupacion`.`request` (
  ...
  `req_ms_project` TEXT DEFAULT NULL,
  ...
  `req_status` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL DEFAULT NULL,
